    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden" aria-label="Hero">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
        <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
          <div className="w-full md:w-2/5 flex justify-center md:justify-start flex-shrink-0">
            <div className="w-64 h-80 sm:w-72 sm:h-96 md:w-80 md:h-[440px] rounded-2xl overflow-hidden shadow-2xl border-4 border-[#C9A84C]/40">
              <img
                src="/images/placeholder.jpg"
                alt="Chess Academy Founder"
          ...
          <div className="w-full md:w-3/5 text-center md:text-left">
            ...
            <p className="text-white/80 text-lg sm:text-xl font-body leading-relaxed mb-10 max-w-xl mx-auto md:mx-0">
